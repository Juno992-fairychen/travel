...
object DriverTransation {
  ...
  def _per_order_rate(sparkSession: SparkSession): Unit ={
    ...
    //日/周/月/季/年 - 平台订单完成率
    SparkSQLHBaseSink.saveToHBase(final_summary_pat_order,"final_summary_pat_order","rk,city_name,_year_comple_rate,_quarter_comple_rate,_month_comple_rate,_week_comple_rate,_day_comple_rate")
    ...
    SparkSQLHBaseSink.saveToHBase(_driver_order_summary,"_driver_order_summary","rk,driver_id,driver_name,_year_comple_rate,_quarter_comple_rate,_month_comple_rate,_week_comple_rate,_day_comple_rate")
    ...
    SparkSQLHBaseSink.saveToHBase(_register_driver,"_register_driver","rk,register_city,_register_year_num,_register_quarter_num,_register_month_num,_register_week_num,_register_day_num")
