...
//  * Created by laowang
//  */
//object HbaseTools_DStream extends Logging with Serializable {
//
//
//
...
//    //获取offset的值
//    var getOffset:collection.Map[TopicPartition, Long]  = HbaseTools_DStream.getOffsetFromHBase(connection,admin,topics,group)
...
//    val conn: Connection = HbaseTools_DStream.getHbaseConn
...
//          type_ match {
//            case "insert" =>
//              HbaseTools_DStream.putMapData(conn ,tableName,  rowkey, mapData)
//            case "update" =>
//              HbaseTools_DStream.putMapData(conn ,tableName, rowkey, mapData)
//            case _=> Nil
//          }
